...
attributeNames = ['Horsepower', 'Torque (lb-ft)', '0-60 MPH Time (seconds)']
...
# Values of lambda
lambdas = [0, np.power(10., -3), np.power(10., -2), np.power(10., -1),  np.power(10., 1), np.power(10., 2), np.power(10., 3), np.power(10., 4), np.power(10., 5)]
lambdas
